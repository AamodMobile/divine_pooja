...
class ItemListView extends StatefulWidget {
  ...
  const ItemListView({super.key, required this.id, required this.title});
...
class _ItemListViewState extends State<ItemListView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      initState: (state) {
        Get.find<ItemController>().itemListGet(widget.id, true);
      },
      builder: (contextCtr) {
        return SafeArea(
          child: Scaffold(
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              homeController.cartCount.value,
                              style: TextStyle(
                                color: Colors.white,
                                fontFamily: regular,
            ...
            body: Padding(
              ...
              child: Builder(builder: (context) {
                ...
                if (contextCtr.itemList.isEmpty) {
                  return Column(
                    children: [
                      SizedBox(
                        height: 130.h,
                  ...
                  children: [
                    Expanded(
                      child: GridView.builder(
                        ...
                        itemCount: contextCtr.itemList.length,
                        itemBuilder: (context, index) {
                          return SlideTransition(
                            position: _offsetAnimation,
                            child: GestureDetector(
                              onTap: () {
                                Get.to(() => ItemDetailsView(productId: contextCtr.itemList[index].id.toString()), transition: Transition.fadeIn, duration: const Duration(seconds: 1));
                              },
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child:  contextCtr.itemList[index].image != ""
                                              ? CachedNetworkImage(
                                            ...
                                            fit: BoxFit.fill,
                                            width: MediaQuery.of(context).size.width,
                                            imageUrl: ApiUrl.imageUrl +contextCtr.itemList[index].image.toString(),
                                        ...
                                        Positioned(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              contextCtr.addWishList(widget.id, contextCtr.itemList[index].id.toString(), false);
                                            },
                                            child: Container(
                                              padding: EdgeInsets.all(5.dm),
                                              child: Image.asset(
                                                contextCtr.itemList[index].isLike == 1 ? heartFillIc : heartIc,
                                                height: 20.h,
                                                width: 20.w,
                                              ),
                                            ),
                                    ...
                                    SizedBox(height: 4.h),
                                    Text(
                                      contextCtr.itemList[index].name.toString(),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 5.w),
                                        Text(
                                          "${contextCtr.itemList[index].averageRating == "" ? "0.0" : contextCtr.itemList[index].averageRating} (${contextCtr.itemList[index].ratingCount})",
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            color: borderCl,
                                            fontFamily: medium,
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        text: "₹ ${contextCtr.itemList[index].price}  ",
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontFamily: semiBold,
                                          fontWeight: FontWeight.w600,
                                        ...
                                        children: [
                                          TextSpan(
                                            text: "₹ ${contextCtr.itemList[index].regularPrice}",
                                            style: TextStyle(
                                              color: greyTextCl,
                                              fontFamily: semiBold,
                                              fontWeight: FontWeight.w400,
                                    ...
                                    SizedBox(
                                      ...
                                      child: CustomButtonWidget(
                                        ...
                                        onPressed: () {
                                          if(contextCtr.itemList[index].isCart.toString()=="1"){
                                            Get.to(() => const CheckOutView(), transition: Transition.rightToLeft, duration: const Duration(milliseconds: 250));
                                          }else{
                                            contextCtr.addCartApi(widget.id,contextCtr.itemList[index].id.toString(), "1",false,false);
                                          }

                                        },
                                        text: contextCtr.itemList[index].isCart.toString()=="1"?"Go to cart":"Add To Cart",
